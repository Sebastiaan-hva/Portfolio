...
<article class="project-card" class:featured class:compact>
	...
	<div class="project-card-inner">
		<div class="project-image-column">
			...
			{#if imageSrc}
				<img src={imageSrc} alt="{title} preview" class="project-image" class:image-contain={imageContain} />
			{:else}
			...
			<div class="links">
				...
				{#if readmeLink && readmeLink !== '#'}
					<a href={readmeLink} target="_blank" class="link-button readme">
						<svg class="btn-icon-left" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
